...
internal static class RegisterUserCommandValidator
{
    public static Dictionary<string, string[]> Validate(RegisterUserCommand command)
    {
        var errors = new Dictionary<string, List<string>>();

        ValidateEmail(command.Email, errors);
        ValidateDisplayName(command.DisplayName, errors);
    ...
    {
        const string key = nameof(RegisterUserCommand.Email);
    ...
    {
        const string key = nameof(RegisterUserCommand.DisplayName);
    ...
    {
        const string key = nameof(RegisterUserCommand.Password);
